...
*/
object Extractors {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(288); 
  println("Welcome to the Scala worksheet")
	...
	FreeUser.unapply(new FreeUser("Abhijeet"));System.out.println("""res0: Option[String] = """ + $show(res$0));$skip(192); 
	...
	val user: User = new PremiumUser("Daniel");System.out.println("""user  : week7.Extractors.User = """ + $show(user ));$skip(180); val res$1 = 
  user match {
